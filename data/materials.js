...
var MATERIALS_DATA = [
  {
    ...
    category: "材料",
    desc: "桃花，花仙子的核心材料。可用于合成大量专属道具与食物；用于修复花仙子专属武器；积攒足够数量后崇拜（worship）可复活角色。",
    obtain: "花仙子角色定期生成",
    usage: "合成专属道具/食物；修复专属武器；崇拜复活角色",
    recipe: "",
    skins: []
  },
  {
  ...
  },
  {
    ...
    category: "材料",
    desc: "幻梦蘑菇的采集产物。每次食用均可令世界降雨，并永久增加5点最大生命值上限，同时开启/叠加常驻生命回复效果（每秒回复1HP）。可用于合成幻锋、折枝等专属道具。",
    obtain: "采摘幻梦蘑菇",
    usage: "直接食用（特殊效果）；合成幻锋、折枝等专属道具",
    recipe: "",
    skins: [],
    hunger: 5,
    health: 3,
  ...
  ,{
    ...
    category: "材料",
    desc: "用于强化花仙子专属武器（幻锋/幻柳）的特殊结晶，每次强化可提升武器等级，解锁更强的技能效果。",
    obtain: "花仙子专属合成",
    usage: "对幻锋/幻柳使用，提升武器等级与伤害",
    recipe: "",
    skins: []
  }
];
