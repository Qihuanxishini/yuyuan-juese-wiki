...
var PLANTS_DATA = [
  {
    ...
    category: "植物",
    desc: "圆圆橘子树，五阶段生长（萌芽→树苗→成长→开花→结果），全程约53分钟。成熟后采摘可获得7个圆圆橘子，采摘后树木消失需重新种植。萌芽期不可砍伐，树苗期起可砍伐获得木头。不可挖掘移植。",
    obtain: "种植圆圆橘子树种",
  ...
  },
  {
    ...
    category: "植物",
    desc: "纷纷草莓丛，永续生长，不会贫瘠枯萎。采摘后约15分钟（随机±5分钟）再生，每次可采摘5个草莓。冬季停止生长。可用铲子挖掘移植，挖掘时若有草莓会一并掉落。",
