...
var ITEMS_DATA = [
  {
    ...
    recipe:
      "桃花 x30，黄金草叉 x1，黄金园艺锄 x1，黄金斧头 x1，黄金铲子 x1，黄金鹤嘴锄 x1，捕虫网 x5",
    skins: [
      {
        name: "甜品叉",
        icon: "wanyuan_tools_tianhai_sweet.png",
        desc: "粉嫩可爱的甜品风格皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "背包槽装备；3页×18格（共54格）；护甲80%（不可破坏）；平面防御+20；隔热360；移速+35%；食物保鲜90%；踏水行走",
  ...
  },
  {
    ...
    skins: [
      {
        name: "花月夜",
        icon: "wanyuan_xiaodeng_skin1.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后作为3页×9格储物容器；第一页第5格放蓝宝石→生成冰块；放红宝石→自动烹饪/晾干；放彩虹宝石→随机生成花仙子食物；始终每60秒修复容器内物品耐久",
    recipe: "桃花 x99，萤火虫 x9，金块 x20，彩虹宝石 x3",
    skins: [
      {
        name: "永恒",
        icon: "wanyuan_xingxingguan_skin_1.png",
        desc: "Elegant 品质皮肤",
      },
      {
        name: "观星",
        icon: "wanyuan_xingxingguan_skin_2.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  {
    ...
    skins: [
      {
        name: "史莱姆",
        icon: "wanyuan_pack_slime.png",
        desc: "Elegant 品质皮肤，制作出的打包熊有多种颜色变体",
      },
    ],
  },
  {
    ...
    skins: [
      {
        name: "迷",
        icon: "wanyuan_cat_box_skin.png",
        desc: "Elegant 品质皮肤",
      },
      {
        name: "蓝",
        icon: "wanyuan_cat_box_skin1.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后作为储物箱（5页共180格，无限堆叠），并兼作科技站；支持一键存入。阶段科技：云梦=科学2、钓鱼1；云梦·贰=科学2、魔法2、航海1、钓鱼1；云梦·叁=科学2、魔法3、远古2、天体1、航海2、钓鱼1、月锻1、影锻1；云梦·极=科学2、魔法3、远古4、天体3、航海2、钓鱼1、月锻2、影锻2",
    recipe:
      "初始：木板 x10、石砖 x5、红宝石 x3、蓝宝石 x3；升贰：齿轮 x3、金块 x10、龙鳞 x2；升叁：铥矿 x6、噩梦燃料 x12、月岩 x8、亮茄外壳 x6；升极：铥矿 x10、月岩 x12、纯粹辉煌 x4、恐怖燃料 x4",
    skins: [
      {
        name: "心云球",
        icon: "wanyuan_yunmeng_box_skin_rod.png",
        desc: "Elegant 品质皮肤",
      },
      {
        name: "福福",
        icon: "wanyuan_yunmeng_box_skin_fufu.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后存放食物（16格，无限堆叠）；极大延缓腐烂（保鲜-9）；可为暖暖石降温；一键存入",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "点击地面或海面施法；扫描16格内大树/矿石/作物/植物，生成分身自动采集；消耗5精神，施法后进入充能",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "对目标使用：按耐久比例返还配方材料；自动清空容器/收获作物；花仙子冷却2秒，其他角色8秒",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "远程攻击（伤害50，射程10/16）；对敌施法召唤龙卷风（花仙子×3/冷却8秒；其他×1/冷却18秒/-30精神/-10生命）",
    recipe:
      "桃花 x75，金块 x35，信天翁羽毛 x5，鹅毛 x3，信天翁喙 x1，触手皮 x2",
    skins: [
      {
        name: "桂",
        icon: "wanyuan_fan_tao_skin.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "头部装备（基础护甲35%）；消耗沙之石→沙尘暴免疫；消耗绿宝石→受击回复生命；消耗彩虹宝石（×5）→强化回复至6HP/次；消耗铥矿（×12）→护甲强化至95%；提供月龄保护",
    recipe: "花瓣 x12，精神消耗 x20，生命消耗 x20，红宝石 x5，紫宝石 x5",
    skins: [
      {
        name: "折枝-靛青",
        icon: "wanyuan_zhezhi_none.png",
        desc: "Elegant 品质皮肤",
      },
      {
        name: "折枝-纷",
        icon: "wanyuan_zhezhi_sk.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后自动生产蜂蜜（需附近有花朵，非冬季）；蜂蜜满40个时采收；蜂蜜≥30时额外获得1~3蜂王浆",
    recipe: "桃花 x35，精神消耗 x20，蜜蜂 x12，蜂巢 x4，蜂王浆 x5",
    skins: [
      {
        name: "咕噜球",
        icon: "wanyuan_beebox_skin_guluqiu.png",
        desc: "Elegant 品质免费皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后进入水域范围即触发效果：持续回复生命/精神/饥饿；减少生命惩罚；夏天制冷，冬天保暖",
  ...
  },
  {
    ...
    usage:
      "食用回复生命3/饥饿3/精神1；低状态触发额外回复（生命+8/饥饿+10/精神+5）",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "近战武器（35+连击×5伤害）；平面伤害+25；暗影阵营×2.5；闪电属性；无耐久",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "近战挥砍武器（基础伤害 0，攻击距离 1.5/2）；左键、F、Ctrl+F 都会触发【破釜沉舟】回春攻击；适合抢救友方或临时抬高目标血线，但回复生命会在 10 秒内逐步衰减",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后加入可燃物开启；光照半径15；夜间植物仍可生长；锤击拆除掉落萤火虫",
    recipe: "木板 x4，金块 x2，萤火虫 x4，黄宝石 x2，绿宝石 x2",
    skins: [
      {
        name: "岩石皮肤",
        icon: "wanyuan_yuelideng_skin_rocks.png",
        desc: "坚硬岩石风格皮肤",
      },
    ],
  },
  {
    ...
    obtain: "角色出生自带",
    usage:
      "近战武器（基础伤害 95）；右键【流星坠击】AOE 跳击；装备时可切换为幻柳形态",
    recipe: "",
    skins: [
      {
        name: "少阳剑",
        icon: "wanyuan_fickle_sword_skin.png",
        desc: "Elegant 品质皮肤",
      },
    ],
  },
  {
    ...
    obtain: "装备幻锋后切换形态获得",
    usage:
      "近战鞭形武器；右键【蓄力鞭挞】直线路径 AOE 伤害+治疗；装备时可切换回幻锋形态",
    recipe: "",
    skins: [],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后放入花瓣或恶魔花瓣（占用格数超过3格）；每300秒刷新周围花朵；夜间自动亮灯",
    recipe: "木头 x1，花瓣 x4，石头 x3",
    skins: [
      {
        name: "多肉",
        icon: "wanyuan_huahui_skin1.png",
        desc: "Elegant 品质免费皮肤",
      },
      {
        name: "百合",
        icon: "wanyuan_huahui_skin2.png",
        desc: "Elegant 品质免费皮肤",
      },
      {
        name: "墨玉",
        icon: "wanyuan_huahui_skin3.png",
        desc: "Elegant 品质免费皮肤",
      },
      {
        name: "秋菊",
        icon: "wanyuan_huahui_skin4.png",
        desc: "Elegant 品质免费皮肤",
      },
      {
        name: "香荷",
        icon: "wanyuan_huahui_skin5.png",
        desc: "Elegant 品质免费皮肤",
      },
    ],
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "右键打开播放器后播放音乐，提供光照，并为附近5格内玩家施加「悠扬乐曲」Buff（+15%移速，生命/理智恢复）。",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成",
    usage:
      "放置后可睡觉恢复状态；可继续消耗木板 x5、萤火虫 x5 升级为强化版旅行帐篷；升级后黄昏/夜晚自动亮灯",
  ...
  },
  {
    ...
    obtain: "花仙子专属合成（装饰分类）",
    usage:
      "放置后提供小范围理智光环；对其使用宝石可祈雨，失败会累计下次成功率；可用锤子拆除",
    recipe: "金块 x3，木头 x5",
    skins: [],
  },
  {
    ...
    obtain: "花仙子专属合成（装饰分类）",
    usage:
      "放置后提供小范围理智光环；对其使用金块/纷纷草莓/圆圆橘子/溜溜杨梅可祈运，每次+5幸运；可用锤子拆除",
    recipe: "金块 x3，木头 x5",
    skins: [],
  },
  {
    ...
    obtain: "花仙子专属合成（装饰分类）",
    usage:
      "放置后提供小范围理智光环；对其使用成品食物(烹饪)可祈顺，获得120秒移速+20%效果，重复使用可续时；可用锤子拆除",
    recipe: "金块 x3，木头 x5",
    skins: [],
  },
  {
    ...
    obtain: "花仙子专属合成（装饰分类）",
    usage:
      "放置后提供小范围理智光环；默认外观为梅花，可在拥有皮肤授权时切换迎春花或海棠花外观；可用锤子拆除",
