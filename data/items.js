...
var ITEMS_DATA = [
  {
    ...
    category: "道具",
    desc: "西陵叉，花仙子专属多功能工具。默认【巧】模式：砍伐+挖矿+挖掘；切换【工】模式：锤击+捕网+钓鱼；切换【移】模式：弹出地皮选择界面进行地皮铺设。无论何种模式均可一次耕出 3×3 范围农田（配置后可达 4×4）。",
    obtain: "角色出生自带",
    usage: "右键切换模式：[巧]砍/挖/掘；[工]锤/网/钓；[移]铺地皮",
    recipe: "",
    skins: [
  ...
  },
  {
    ...
    category: "道具",
    desc: "幻仙绫，花仙子专属多功能背包。装备后提供80%护甲吸收（不可破坏）、平面防御+20、隔热360、移速+35%；背包内食物腐烂速度降至10%；同时赋予踏水能力，可在水面行走不会落水（传送/复活后自动恢复）。",
    obtain: "花仙子专属合成",
    usage: "背包槽装备；护甲80%（不可破坏）；平面防御+20；隔热360；移速+35%；食物保鲜90%；踏水行走",
  ...
  },
  {
    ...
    category: "道具",
    desc: "玉暖安，以桃花与金块制成的精巧灯笼，照明取暖。",
    obtain: "花仙子专属合成",
    usage: "可手持提供照明，放置在物品栏会提供温度适宜",
  ...
  },
  {
    ...
    category: "道具",
    desc: "星星许愿罐，存放着数不尽的幻想和愿望，充满梦幻色彩。共两页格子，食物永不腐烂。第5格（第一页）可放入宝石激活特效：放蓝宝石每35秒在罐内生成冰块；放红宝石每100秒自动烹饪/晾干罐内食材；放彩虹宝石每360秒随机生成一个花仙子专属食物。无论放何种宝石，均每60秒修复罐内所有物品5%耐久。",
    obtain: "花仙子专属合成",
    usage: "放置后作为储物容器；第5格放蓝宝石→生成冰块；放红宝石→自动烹饪/晾干；放彩虹宝石→随机生成花仙子食物；始终每60秒修复容器内物品耐久",
  ...
  },
  {
    ...
    category: "道具",
    desc: "呆呆熊，可爱的小熊打包盒，有不一样的皮肤提供不同呈现。",
    obtain: "花仙子专属合成",
    usage: "作为背包使用",
  ...
  },
  {
    ...
    category: "道具",
    desc: "云梦，花仙子专属超大储物箱，共5页×36格=180格存储空间，支持无限堆叠。同时兼作花仙子专属科技站，可解锁专属配方。内置放入物品按钮，可一键将背包物品整理存入。",
    obtain: "花仙子专属合成",
    usage: "放置后作为储物箱（5页共180格，无限堆叠）；兼作花仙子专属科技站；内置一键存入按钮",
    recipe: "彩虹宝石 x12，红宝石 x9，蓝宝石 x9，石砖 x30，木板 x60",
    skins: [
  ...
  },
  {
    ...
    category: "道具",
    desc: "爱心法杖，点击地面后自动扫描16格范围内最多20个可操作目标（大树砍伐/矿石挖掘/巨大化作物锤击/可采集植物），为每个目标生成一个爱心分身自动完成操作。消耗5点精神，10秒冷却（充能时间30秒）。",
    obtain: "花仙子专属合成",
  ...
  },
  {
    ...
    category: "道具",
    desc: "折枝，可升级强化的头部装备，基础护甲35%，装备时持续回复精神。支持四条独立升级路径：①消耗沙之石（一次性）解锁沙尘暴免疫；②消耗绿宝石（一次性）解锁承伤回复（受击回复1HP）；③继续消耗彩虹宝石（最多5颗）强化承伤回复（每颗+1HP，上限6HP/次）；④消耗铥矿（最多12颗）强化护甲（每颗+5%，上限95%）。",
    obtain: "花仙子专属合成",
    usage: "头部装备（基础护甲35%）；消耗沙之石→沙尘暴免疫；消耗绿宝石→受击回复生命；消耗彩虹宝石（×5）→强化回复至6HP/次；消耗铥矿（×12）→护甲强化至95%",
  ...
  },
  {
    ...
    category: "道具",
    desc: "迷你盆栽，放入超过3个花瓣后，每300秒在周围5格范围内随机生成若干朵花。夜间自动发出暖粉色小灯光（半径2）。锤击拆除后归还容器内所有物品。",
    obtain: "花仙子专属合成",
    usage: "放置后放入花瓣（>3个）；每300秒刷新周围花朵；夜间自动亮灯",
    recipe: "",
    skins: [
  ...
  },
  {
    ...
    category: "道具",
    desc: "旅行帐篷。黄昏与夜晚会自动亮起暖光；基础状态下提供原版帐篷级别的睡眠恢复。放置后还可继续投入材料升级为强化版，升级后休息时生命与理智回复效率翻倍。",
    obtain: "花仙子专属合成",
    usage: "放置后可睡觉恢复状态；升级后黄昏/夜晚自动亮灯；可继续消耗木板 x5、萤火虫 x5 升级为强化版旅行帐篷",
